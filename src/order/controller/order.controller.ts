...
export class OrderController {
    ...
    public getOrdersByTable = (req: Request, res: Response) => {
        this.orderService.getOrder(req.params.table)
            .then((orders) => {
    ...
    public getOrdersByRestaurant = (req: Request, res: Response) => {
        this.orderService.getOrders(req.params.restaurantId)
            .then((orders) => {
                res.status(StatusCodes.OK).json(orders);
            })
            .catch((error) => {
    ...
    public patchOrder = (req: Request, res: Response) =>{
        ...
        this.orderService.patchOrder(patchOrder)
            .then((order) => {
    ...
    public postOrder = (req: Request, res: Response) => {
        ...
        this.orderService.postOrder(postedOrder)
            .then((order) => {
